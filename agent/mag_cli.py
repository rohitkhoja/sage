#!/usr/bin/env python3
"""
MAG Agent Command Line Interface
Usage: python mag_cli.py function_name "value"
"""
...
def get_papers_by_author(author_ids):
    ...
    ids = [int(x.strip()) for x in author_ids.split(',')]
...
def help_functions():
    ...
    for func in functions:
        print(f"  python mag_cli.py {func}")
    print("\n💡 Examples:")
    print("  python mag_cli.py search_papers_by_title 'machine learning' 5")
    print("  python mag_cli.py get_papers_by_year_range 2010 2020")
    print("  python mag_cli.py solve_query 'papers about AI' my_session")

...
def run_full_mag_pipeline():
    ...
    logger.info(" Estimated time: 8-12 hours")
    logger.info("")
    ...
    try:
        ...
        logger.info("=" * 50)
        logger.info(f" Total time: {total_time:.2f}s ({hours:.2f} hours)")
        ...
        logger.error(f" Failed after: {total_time:.2f}s ({hours:.2f} hours)")
        return False
